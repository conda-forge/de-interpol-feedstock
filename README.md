...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/de-interpol-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/de-interpol-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add de-interpol
# for installing globally
pixi global install de-interpol
```
...
It is possible to list all of the versions of `de-interpol` available on your platform:
...
```
pixi search de-interpol --channel conda-forge
```
